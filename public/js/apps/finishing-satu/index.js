...
var table = NioApp.DataTable('#dt-table-detail', {
    ...
    scrollX: true,
    ajax: {
        url: '/finishing-satu/detail/datatable',
        type: 'POST',
        data: function(d) {
            d._token    = token;
            d.uid       = $('#uid_order').val();
