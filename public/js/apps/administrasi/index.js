...
var table = NioApp.DataTable('#dt-table-detail', {
    ...
    scrollX: true,
    ajax: {
        url: '/administrasi/detail/datatable',
        type: 'POST',
        data: function(d) {
            d._token    = token;
            d.uid       = $('#uid_order').val();
...
var table = NioApp.DataTable('#dt-table-incoming', {
    ...
    scrollY: '500px',
    ajax: {
        url: '/administrasi/datatable-incoming',
        type: 'POST',
        data: function(d) {
            d._token        = token;
        },
