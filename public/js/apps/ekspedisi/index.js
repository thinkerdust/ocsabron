...
var table = NioApp.DataTable('#dt-table-detail', {
    ...
    scrollX: true,
    ajax: {
        url: '/ekspedisi/detail/datatable',
        type: 'POST',
        data: function(d) {
            d._token    = token;
            d.uid       = $('#uid_order').val();
...
var table = NioApp.DataTable('#dt-table-incoming', {
    ...
    scrollX: true,
    ajax: {
        url: '/ekspedisi/datatable-incoming',
        type: 'POST',
        data: function(d) {
            d._token        = token;
        },
