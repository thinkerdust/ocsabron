...
class PackingRepository {
    ...
    public function dataTablePacking($start_date, $end_date, $status, $order_by)
    {
        ...
        $query = DB::table('order as o')
                    ...
                    ->select('o.uid', 'o.nama', 'o.customer', 'o.jenis_produk', 'o.jenis_kertas', 'o.ukuran', 'o.jumlah', 'o.file_spk', 'o.jumlah_koli', 'o.hasil_jadi', 'o.isi', 'd.nama as progress', 'od.status',
