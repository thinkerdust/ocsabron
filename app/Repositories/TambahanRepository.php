...
class TambahanRepository {
    ...
    public function dataTableTambahan($start_date, $end_date, $status, $order_by)
    {
        ...
        $query = DB::table('order as o')
                    ...
                    ->select('o.uid', 'o.nama', 'o.customer', 'o.jenis_produk', 'o.jenis_kertas', 'o.ukuran', 'o.jumlah', 'o.file_spk', 'o.jumlah_koli_tambahan', 'o.hasil_jadi_tambahan', 'o.isi_tambahan', 'd.nama as progress', 'od.status',
    ...
    public function dataTableIncomingJob()
    {
        $query = DB::table('order as o')
                    ...
                    ->where('od.uid_divisi', 'D20241117150641863677')
                    ->where('o.status', 1);
