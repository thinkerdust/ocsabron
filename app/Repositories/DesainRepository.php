...
class DesainRepository {
    ...
    public function dataTableDesain($start_date, $end_date, $status, $order_by)
    {
    ...
    public function cetakDesain($uid) 
    {
    ...
    public function dataTableIncomingJob()
    {
        $query = DB::table('order as o')
                    ...
                    ->where('od.uid_divisi', 'D20241117144239748171')
                    ->where('o.status', 1);
