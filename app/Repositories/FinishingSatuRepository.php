...
class FinishingSatuRepository {
    ...
    public function dataTableFinishingSatu($start_date, $end_date, $status, $order_by)
    {
    ...
    public function dataTableIncomingJob()
    {
        $query = DB::table('order as o')
                    ...
                    ->where('od.uid_divisi', 'D20241117144310427556')
                    ->where('o.status', 1);
