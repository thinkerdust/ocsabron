...
class Order extends Model
{
    ...
    public function getOrder($uid)
    {
        $order = DB::table('order')
                ->where('uid', $uid)
                ->select('uid', 'nama', 'customer', 'jenis_produk', 'ukuran', 'jumlah', 'tambahan', 'jenis_kertas', 'finishing_satu', 'finishing_dua', 'pengambilan', 'order_by', 'keterangan', 'hasil_jadi', 'jumlah_koli', 'isi', 'keterangan_packing', 'hasil_jadi_tambahan', 'jumlah_koli_tambahan', 'isi_tambahan', 'keterangan_tambahan', 'nomor_nota', 'nomor_resi', 'rusak_mesin', 'rusak_cetakan', 'rusak_mesin_forming', 'rusak_cetakan_forming',
